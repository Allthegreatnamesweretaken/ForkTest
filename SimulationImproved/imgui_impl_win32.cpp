...
struct ImGui_ImplWin32_Data // parasoft-suppress  OPT-13-DOWNGRADED "External Library"
{
    HWND                        hWnd;
    HWND                        MouseHwnd;
...
static bool ImGui_ImplWin32_InitEx(void* hwnd, bool platform_has_own_dc)
{
    ...
    ImGui_ImplWin32_Data* bd = IM_NEW(ImGui_ImplWin32_Data)(); // parasoft-suppress  MRM-18 "External Library"
...
{
    ImGui_ImplWin32_Data* bd = ImGui_ImplWin32_GetBackendData(io);
    IM_ASSERT(bd->hWnd != 0); // parasoft-suppress  CODSTA-MCPP-04 "External Library"
...
static void ImGui_ImplWin32_UpdateGamepads(ImGuiIO& io)
{
    ...
    if (bd->WantUpdateHasGamepad)
    {
        ...
        bd->HasGamepad = bd->XInputGetCapabilities ? (bd->XInputGetCapabilities(0, XINPUT_FLAG_GAMEPAD, &caps) == ERROR_SUCCESS) : false; // parasoft-suppress  CODSTA-CPP-65 "External Library"
...
#define WM_MOUSEHWHEEL 0x020E // parasoft-suppress  CODSTA-03 "External Library"
#endif
...
IMGUI_IMPL_API LRESULT ImGui_ImplWin32_WndProcHandlerEx(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam, ImGuiIO& io)
{
    ...
    case WM_SYSKEYUP:
    {
        const bool is_key_down = (msg == WM_KEYDOWN || msg == WM_SYSKEYDOWN); // parasoft-suppress  OPT-01 "External Library"
        if (wParam < 256)
        {
            // Submit modifiers
...
#define _IsWindows8OrGreater()       _IsWindowsVersionOrGreater(HIBYTE(0x0602), LOBYTE(0x0602), 0) // _WIN32_WINNT_WIN8 // parasoft-suppress  MISRA2004-19_7 "External Library"
#define _IsWindows8Point1OrGreater() _IsWindowsVersionOrGreater(HIBYTE(0x0603), LOBYTE(0x0603), 0) // _WIN32_WINNT_WINBLUE // parasoft-suppress  NAMING-01 "External Library"
#define _IsWindows10OrGreater()      _IsWindowsVersionOrGreater(HIBYTE(0x0A00), LOBYTE(0x0A00), 0) // _WIN32_WINNT_WINTHRESHOLD / _WIN32_WINNT_WIN10

#ifndef DPI_ENUMS_DECLARED
typedef enum { PROCESS_DPI_UNAWARE = 0, PROCESS_SYSTEM_DPI_AWARE = 1, PROCESS_PER_MONITOR_DPI_AWARE = 2 } PROCESS_DPI_AWARENESS;
typedef enum { MDT_EFFECTIVE_DPI = 0, MDT_ANGULAR_DPI = 1, MDT_RAW_DPI = 2, MDT_DEFAULT = MDT_EFFECTIVE_DPI } MONITOR_DPI_TYPE; // parasoft-suppress  CODSTA-MCPP-03 "External Library"
#endif
