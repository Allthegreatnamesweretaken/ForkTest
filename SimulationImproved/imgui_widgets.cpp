...
bool ImGui::CheckboxFlags(const char* label, ImU64* flags, ImU64 flags_value) // parasoft-suppress  OPT-24 "External Library"
{
    return CheckboxFlagsT(label, flags, flags_value);
}
...
bool ImGui::BeginComboPopup(ImGuiID popup_id, const ImRect& bb, ImGuiComboFlags flags)
{
    ...
    char name[16]; // parasoft-suppress  STL-37-DOWNGRADED "External Library"
...
static const char* Items_SingleStringGetter(void* data, int idx) // parasoft-suppress  MISRA2004-16_7 "External Library"
{
...
bool ImGui::Combo(const char* label, int* current_item, const char* items_separated_by_zeros, int height_in_items)
{
    ...
    bool value_changed = Combo(label, current_item, Items_SingleStringGetter, (void*)items_separated_by_zeros, items_count, height_in_items); // parasoft-suppress  CODSTA-14 "External Library"
    return value_changed;
}
...
static const char* ImGuiGetNameFromIndexOldToNewCallback(void* user_data, int idx)
{
    ...
    const char* s = NULL; // parasoft-suppress  CODSTA-MCPP-04 "External Library"
...
static const ImGuiDataTypeInfo GDataTypeInfo[] = // parasoft-suppress  STL-37-DOWNGRADED "External Library"
{
...
TYPE ImGui::RoundScalarWithFormatT(const char* format, ImGuiDataType data_type, TYPE v)
{
    ...
    // Sanitize format
    char fmt_sanitized[32]; // parasoft-suppress  STL-37-DOWNGRADED "External Library"
...
bool ImGui::DragBehaviorT(ImGuiDataType data_type, TYPE* v, float v_speed, const TYPE v_min, const TYPE v_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    const bool is_bounded = (v_min < v_max) || ((v_min == v_max) && (v_min != 0.0f || (flags & ImGuiSliderFlags_ClampZeroRange))); // parasoft-suppress  MISRA2004-13_3 "External Library"
    ...
    if (*v != v_cur && is_bounded) // parasoft-suppress  CODSTA-225 "External Library"
    {
        if (is_wrapped)
        {
            // Wrap values
...
bool ImGui::DragBehavior(ImGuiID id, ImGuiDataType data_type, void* p_v, float v_speed, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    switch (data_type)
    {
    case ImGuiDataType_S8:     { ImS32 v32 = (ImS32)*(ImS8*)p_v;  bool r = DragBehaviorT<ImS32, ImS32, float>(ImGuiDataType_S32, &v32, v_speed, p_min ? *(const ImS8*) p_min : IM_S8_MIN,  p_max ? *(const ImS8*)p_max  : IM_S8_MAX,  format, flags); if (r) *(ImS8*)p_v = (ImS8)v32; return r; } // parasoft-suppress  CODSTA-CPP-65 "External Library"
    case ImGuiDataType_U8:     { ImU32 v32 = (ImU32)*(ImU8*)p_v;  bool r = DragBehaviorT<ImU32, ImS32, float>(ImGuiDataType_U32, &v32, v_speed, p_min ? *(const ImU8*) p_min : IM_U8_MIN,  p_max ? *(const ImU8*)p_max  : IM_U8_MAX,  format, flags); if (r) *(ImU8*)p_v = (ImU8)v32; return r; }
    case ImGuiDataType_S16:    { ImS32 v32 = (ImS32)*(ImS16*)p_v; bool r = DragBehaviorT<ImS32, ImS32, float>(ImGuiDataType_S32, &v32, v_speed, p_min ? *(const ImS16*)p_min : IM_S16_MIN, p_max ? *(const ImS16*)p_max : IM_S16_MAX, format, flags); if (r) *(ImS16*)p_v = (ImS16)v32; return r; }
    case ImGuiDataType_U16:    { ImU32 v32 = (ImU32)*(ImU16*)p_v; bool r = DragBehaviorT<ImU32, ImS32, float>(ImGuiDataType_U32, &v32, v_speed, p_min ? *(const ImU16*)p_min : IM_U16_MIN, p_max ? *(const ImU16*)p_max : IM_U16_MAX, format, flags); if (r) *(ImU16*)p_v = (ImU16)v32; return r; } // parasoft-suppress  CODSTA-CPP-65 "External Library"
    case ImGuiDataType_S32:    return DragBehaviorT<ImS32, ImS32, float >(data_type, (ImS32*)p_v,  v_speed, p_min ? *(const ImS32* )p_min : IM_S32_MIN, p_max ? *(const ImS32* )p_max : IM_S32_MAX, format, flags); // parasoft-suppress  CODSTA-CPP-65 "External Library"
    case ImGuiDataType_U32:    return DragBehaviorT<ImU32, ImS32, float >(data_type, (ImU32*)p_v,  v_speed, p_min ? *(const ImU32* )p_min : IM_U32_MIN, p_max ? *(const ImU32* )p_max : IM_U32_MAX, format, flags); // parasoft-suppress  CODSTA-CPP-65 "External Library"
    case ImGuiDataType_S64:    return DragBehaviorT<ImS64, ImS64, double>(data_type, (ImS64*)p_v,  v_speed, p_min ? *(const ImS64* )p_min : IM_S64_MIN, p_max ? *(const ImS64* )p_max : IM_S64_MAX, format, flags); // parasoft-suppress  CODSTA-CPP-65 "External Library"
    case ImGuiDataType_U64:    return DragBehaviorT<ImU64, ImS64, double>(data_type, (ImU64*)p_v,  v_speed, p_min ? *(const ImU64* )p_min : IM_U64_MIN, p_max ? *(const ImU64* )p_max : IM_U64_MAX, format, flags); // parasoft-suppress  CODSTA-CPP-65 "External Library"
...
{
    ImGuiWindow* window = GetCurrentWindow(); // parasoft-suppress  CDD-DUPC "External Library"
    if (window->SkipItems)
        return false;
...
bool ImGui::DragFloat2(const char* label, float v[2], float v_speed, float v_min, float v_max, const char* format, ImGuiSliderFlags flags) // parasoft-suppress  OPT-24 "External Library"
{
...
bool ImGui::DragFloat4(const char* label, float v[4], float v_speed, float v_min, float v_max, const char* format, ImGuiSliderFlags flags) // parasoft-suppress  CODSTA-15 "External Library"
{
...
{
    if (v_min == v_max) // parasoft-suppress  CODSTA-225 "External Library" // parasoft-suppress  MISRA2004-13_3 "External Library"
        return 0.0f;
    IM_UNUSED(data_type);
    ...
    if (is_logarithmic)
    {
        ...
        if ((v_min == 0.0f) && (v_max < 0.0f)) // parasoft-suppress  MISRA2004-13_3 "External Library"
    ...
    if (g.ActiveId == id)
    {
        ...
        else if (g.ActiveIdSource == ImGuiInputSource_Keyboard || g.ActiveIdSource == ImGuiInputSource_Gamepad)
        {
            ...
            if (input_delta != 0.0f)
            {
                ...
                {
                    if ((v_range_f >= -100.0f && v_range_f <= 100.0f && v_range_f != 0.0f) || tweak_slow) // parasoft-suppress  MISRA2004-13_3 "External Library"
        ...
        if (set_new_value)
        {
            ...
            // Apply result
            if (*v != v_new) // parasoft-suppress  CODSTA-225 "External Library" // parasoft-suppress  MISRA2004-13_3 "External Library"
            {
                *v = v_new;
                value_changed = true;
            }
...
bool ImGui::SliderFloat2(const char* label, float v[2], float v_min, float v_max, const char* format, ImGuiSliderFlags flags) // parasoft-suppress  OPT-24 "External Library"
{
...
bool ImGui::SliderFloat4(const char* label, float v[4], float v_min, float v_max, const char* format, ImGuiSliderFlags flags) // parasoft-suppress  CODSTA-15 "External Library"
{
...
bool ImGui::SliderInt3(const char* label, int v[3], int v_min, int v_max, const char* format, ImGuiSliderFlags flags) // parasoft-suppress  OPT-24 "External Library"
{
...
bool ImGui::VSliderInt(const char* label, const ImVec2& size, int* v, int v_min, int v_max, const char* format, ImGuiSliderFlags flags) // parasoft-suppress  OPT-24 "External Library"
{
...
bool ImGui::InputFloat3(const char* label, float v[3], const char* format, ImGuiInputTextFlags flags) // parasoft-suppress  CODSTA-15 "External Library"
{
    return InputScalarN(label, ImGuiDataType_Float, v, 3, NULL, NULL, format, flags);
}

bool ImGui::InputFloat4(const char* label, float v[4], const char* format, ImGuiInputTextFlags flags) // parasoft-suppress  OPT-24 "External Library"
{
...
bool ImGui::InputInt2(const char* label, int v[2], ImGuiInputTextFlags flags) // parasoft-suppress  CODSTA-15 "External Library"
{
...
bool ImGui::InputInt4(const char* label, int v[4], ImGuiInputTextFlags flags) // parasoft-suppress  CODSTA-15 "External Library"
{
...
{
    static const unsigned int separator_list[] = // parasoft-suppress  STL-37-DOWNGRADED "External Library"
    {
...
static int  STB_TEXTEDIT_MOVEWORDRIGHT_IMPL(ImGuiInputTextState* obj, int idx)  { ImGuiContext& g = *obj->Ctx; if (g.IO.ConfigMacOSXBehaviors) return STB_TEXTEDIT_MOVEWORDRIGHT_MAC(obj, idx); else return STB_TEXTEDIT_MOVEWORDRIGHT_WIN(obj, idx); } // parasoft-suppress  INIT-05 "External Library"
...
#define STB_TEXTEDIT_K_LINESTART    0x200004 // keyboard input to move cursor to start of line // parasoft-suppress  CODSTA-03 "External Library"
...
#define IMSTB_TEXTEDIT_memmove memmove // parasoft-suppress  NAMING-01 "External Library"
#include "imstb_textedit.h"
...
void ImGuiInputTextCallbackData::InsertChars(int pos, const char* new_text, const char* new_text_end)
{
    ...
    const int new_text_len = new_text_end ? (int)(new_text_end - new_text) : (int)strlen(new_text); // parasoft-suppress  CODSTA-CPP-65 "External Library"
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ...
    if (g.ActiveId == id)
    {
        ...
        else if (io.MouseDown[0] && !state->SelectedAllMouseLock && (io.MouseDelta.x != 0.0f || io.MouseDelta.y != 0.0f)) // parasoft-suppress  MISRA2004-13_3 "External Library"
        {
            stb_textedit_drag(state, state->Stb, mouse_x, mouse_y);
            state->CursorAnimReset();
        ...
        const bool ignore_char_inputs = (io.KeyCtrl && !io.KeyAlt) || (is_osx && io.KeyCtrl); // parasoft-suppress  OPT-01 "External Library"
    ...
    if (state)
        state->TextSrc = NULL; // parasoft-suppress  CODSTA-MCPP-04 "External Library"
    ...
    else if ((flags & ImGuiColorEditFlags_DisplayHex) != 0 && (flags & ImGuiColorEditFlags_NoInputs) == 0)
    {
        ...
        if (InputText("##Text", buf, IM_ARRAYSIZE(buf), ImGuiInputTextFlags_CharsUppercase))
        {
            ...
            if (alpha)
                ...
                r = sscanf(p, "%02X%02X%02X", (unsigned int*)&i[0], (unsigned int*)&i[1], (unsigned int*)&i[2]); // parasoft-suppress  CODSTA-CPP-01 "External Library"
...
bool ImGui::ColorPicker4(const char* label, float col[4], ImGuiColorEditFlags flags, const float* ref_col)
{
    ...
    // Setup
    int components = (flags & ImGuiColorEditFlags_NoAlpha) ? 3 : 4; // parasoft-suppress  CODSTA-CPP-65 "External Library"
...
void ImGui::ColorEditOptionsPopup(const float* col, ImGuiColorEditFlags flags)
{
    ...
    if (BeginPopup("Copy"))
    {
        int cr = IM_F32_TO_INT8_SAT(col[0]), cg = IM_F32_TO_INT8_SAT(col[1]), cb = IM_F32_TO_INT8_SAT(col[2]), ca = (flags & ImGuiColorEditFlags_NoAlpha) ? 255 : IM_F32_TO_INT8_SAT(col[3]);
        char buf[64];
        ImFormatString(buf, IM_ARRAYSIZE(buf), "(%.3ff, %.3ff, %.3ff, %.3ff)", col[0], col[1], col[2], (flags & ImGuiColorEditFlags_NoAlpha) ? 1.0f : col[3]); // parasoft-suppress  CODSTA-CPP-65 "External Library"
        if (Selectable(buf))
...
bool ImGui::TreeNodeUpdateNextOpen(ImGuiID storage_id, ImGuiTreeNodeFlags flags)
{
    ...
    {
        is_open = storage->GetInt(storage_id, (flags & ImGuiTreeNodeFlags_DefaultOpen) ? 1 : 0) != 0; // parasoft-suppress  CODSTA-CPP-65 "External Library"
    }
...
bool ImGui::TreeNodeBehavior(ImGuiID id, ImGuiTreeNodeFlags flags, const char* label, const char* label_end)
{
    ...
    ImGuiID storage_id = (g.NextItemData.HasFlags & ImGuiNextItemDataFlags_HasStorageID) ? g.NextItemData.StorageId : id; // parasoft-suppress  CODSTA-CPP-65 "External Library"
    ...
    // Render
    {
        ...
        else
        {
            ...
            if (flags & ImGuiTreeNodeFlags_Bullet)
                ...
                RenderArrow(window->DrawList, ImVec2(text_pos.x - text_offset_x + padding.x, text_pos.y + g.FontSize * 0.15f), text_col, is_open ? ((flags & ImGuiTreeNodeFlags_UpsideDownArrow) ? ImGuiDir_Up : ImGuiDir_Down) : ImGuiDir_Right, 0.70f); // parasoft-suppress  CODSTA-CPP-65 "External Library"
            if (g.LogEnabled)
                LogSetNextTextDecoration(">", NULL);
        }
...
bool ImGui::BeginBoxSelect(const ImRect& scope_rect, ImGuiWindow* window, ImGuiID box_select_id, ImGuiMultiSelectFlags ms_flags)
{
    ...
    if (ms_flags & ImGuiMultiSelectFlags_BoxSelect2d)
        if (bs->BoxSelectRectPrev.Min.x != bs->BoxSelectRectCurr.Min.x || bs->BoxSelectRectPrev.Max.x != bs->BoxSelectRectCurr.Max.x) // parasoft-suppress  CODSTA-225 "External Library"
        {
            bs->UnclipMode = true;
...
void ImGui::DebugNodeMultiSelectState(ImGuiMultiSelectState* storage)
{
    ...
    bool open = TreeNode((void*)(intptr_t)storage->ID, "MultiSelect 0x%08X in '%s'%s", storage->ID, storage->Window ? storage->Window->Name : "N/A", is_active ? "" : " *Inactive*"); // parasoft-suppress  CODSTA-CPP-65 "External Library"
...
{
    Size = 0; // parasoft-suppress  INIT-14 "External Library"
    PreserveOrder = false;
    UserData = NULL;
    AdapterIndexToStorageId = [](ImGuiSelectionBasicStorage*, int idx) { return (ImGuiID)idx; }; // parasoft-suppress  INIT-14 "External Library"
...
{
    UserData = NULL;
    AdapterSetItemSelected = NULL; // parasoft-suppress  CODSTA-MCPP-04 "External Library"
}
...
{
    const bool value_changed = ListBox(label, current_item, Items_ArrayGetter, (void*)items, items_count, height_items); // parasoft-suppress  CODSTA-14 "External Library"
    return value_changed;
}
...
void ImGui::PlotLines(const char* label, const float* values, int values_count, int values_offset, const char* overlay_text, float scale_min, float scale_max, ImVec2 graph_size, int stride) // parasoft-suppress  OPT-14 "External Library"
{
...
void ImGui::Value(const char* prefix, bool b) // parasoft-suppress  OPT-24 "External Library"
{
...
void ImGui::Value(const char* prefix, float v, const char* float_format)
{
    if (float_format)
    {
        char fmt[64]; // parasoft-suppress  STL-37-DOWNGRADED "External Library"
...
bool ImGui::BeginViewportSideBar(const char* name, ImGuiViewport* viewport_p, ImGuiDir dir, float axis_size, ImGuiWindowFlags window_flags)
{
    ...
    if (bar_window == NULL || bar_window->BeginCount == 0)
    {
        ...
        ImGuiViewportP* viewport = (ImGuiViewportP*)(void*)(viewport_p ? viewport_p : GetMainViewport()); // parasoft-suppress  CODSTA-CPP-65 "External Library"
...
bool ImGui::MenuItem(const char* label, const char* shortcut, bool selected, bool enabled) // parasoft-suppress  OPT-24 "External Library"
{
...
{
    memset(this, 0, sizeof(*this));
    CurrFrameVisible = PrevFrameVisible = -1; // parasoft-suppress  INIT-14 "External Library"
    LastTabItemIdx = -1;
}
...
{
    ImGuiContext& g = *GImGui; // parasoft-suppress  INIT-05 "External Library"
    return ref.Ptr ? (ImGuiTabBar*)ref.Ptr : g.TabBars.GetByIndex(ref.Index); // parasoft-suppress  CODSTA-CPP-65 "External Library"
}
