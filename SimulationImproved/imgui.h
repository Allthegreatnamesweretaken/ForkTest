...
#define IM_FMTARGS(FMT)             __attribute__((format(gnu_printf, FMT, FMT+1))) /* parasoft-suppress  MISRA2004-19_7 "External Library" */
...
typedef signed short        ImS16;  // 16-bit signed integer /* parasoft-suppress  CODSTA-MCPP-02 "External Library" */
typedef unsigned short      ImU16;  // 16-bit unsigned integer
typedef signed int          ImS32;  // 32-bit signed integer == int
typedef unsigned int        ImU32;  // 32-bit unsigned integer (often used to store packed colors)
typedef signed   long long  ImS64;  // 64-bit signed integer
typedef unsigned long long  ImU64;  // 64-bit unsigned integer /* parasoft-suppress  CODSTA-MCPP-02 "External Library" */
...
typedef int ImGuiStyleVar;          // -> enum ImGuiStyleVar_        // Enum: A variable identifier for styling /* parasoft-suppress  CODSTA-MCPP-02 "External Library" */
...
typedef int ImGuiConfigFlags;       // -> enum ImGuiConfigFlags_     // Flags: for io.ConfigFlags /* parasoft-suppress  CODSTA-MCPP-02 "External Library" */
typedef int ImGuiComboFlags;        // -> enum ImGuiComboFlags_      // Flags: for BeginCombo()
typedef int ImGuiDragDropFlags;     // -> enum ImGuiDragDropFlags_   // Flags: for BeginDragDropSource(), AcceptDragDropPayload() /* parasoft-suppress  CODSTA-MCPP-02 "External Library" */
...
typedef unsigned int ImWchar32;     // A single decoded U32 character/code point. We encode them as multi bytes UTF-8 when used in strings. /* parasoft-suppress  CODSTA-MCPP-02 "External Library" */
...
namespace ImGui
{
    ...
    IMGUI_API void          ShowIDStackToolWindow(bool* p_open = NULL); // create Stack Tool window. hover items with mouse to query information about the source of their unique ID. /* parasoft-suppress  CODSTA-MCPP-04 "External Library" */
    ...
    IMGUI_API void          StyleColorsClassic(ImGuiStyle* dst = NULL); // classic imgui style /* parasoft-suppress  CODSTA-MCPP-04 "External Library" */
    ...
    IMGUI_API void          SetNextWindowSizeConstraints(const ImVec2& size_min, const ImVec2& size_max, ImGuiSizeCallback custom_callback = NULL, void* custom_callback_data = NULL); // set next window size limits. use 0.0f or FLT_MAX if you don't want limits. Use -1 for both min and max of same axis to preserve current size (which itself is a constraint). Use callback to apply non-trivial programmatic constraints. /* parasoft-suppress  CODSTA-MCPP-04 "External Library" */
    ...
    IMGUI_API ImVec2        GetCursorPos();                                                 // [window-local] cursor position in window-local coordinates. This is not your best friend. /* parasoft-suppress  OPT-33 "External Library" */
    ...
    IMGUI_API ImVec2        GetCursorStartPos();                                            // [window-local] initial cursor position, in window-local coordinates. Call GetCursorScreenPos() after Begin() to get the absolute coordinates version. /* parasoft-suppress  OPT-33 "External Library" */
    ...
    // Widgets: Text
    IMGUI_API void          TextUnformatted(const char* text, const char* text_end = NULL); // raw text without formatting. Roughly equivalent to Text("%s", text) but: A) doesn't require null terminated string if 'text_end' is specified, B) it's faster, no memory copy is done, no buffer size limits, recommended for long chunks of text. /* parasoft-suppress  CODSTA-MCPP-04 "External Library" */
    ...
    IMGUI_API bool          SliderInt2(const char* label, int v[2], int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0); /* parasoft-suppress  CODSTA-15 "External Library" */
    ...
    IMGUI_API bool          InputTextMultiline(const char* label, char* buf, size_t buf_size, const ImVec2& size = ImVec2(0, 0), ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL); /* parasoft-suppress  CODSTA-MCPP-04 "External Library" */
    IMGUI_API bool          InputTextWithHint(const char* label, const char* hint, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
    IMGUI_API bool          InputFloat(const char* label, float* v, float step = 0.0f, float step_fast = 0.0f, const char* format = "%.3f", ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputFloat2(const char* label, float v[2], const char* format = "%.3f", ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputFloat3(const char* label, float v[3], const char* format = "%.3f", ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputFloat4(const char* label, float v[4], const char* format = "%.3f", ImGuiInputTextFlags flags = 0); /* parasoft-suppress  CODSTA-15 "External Library" */
    IMGUI_API bool          InputInt(const char* label, int* v, int step = 1, int step_fast = 100, ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputInt2(const char* label, int v[2], ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputInt3(const char* label, int v[3], ImGuiInputTextFlags flags = 0); /* parasoft-suppress  CODSTA-15 "External Library" */
    IMGUI_API bool          InputInt4(const char* label, int v[4], ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputDouble(const char* label, double* v, double step = 0.0, double step_fast = 0.0, const char* format = "%.6f", ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_step = NULL, const void* p_step_fast = NULL, const char* format = NULL, ImGuiInputTextFlags flags = 0); /* parasoft-suppress  CODSTA-MCPP-04 "External Library" */
    IMGUI_API bool          InputScalarN(const char* label, ImGuiDataType data_type, void* p_data, int components, const void* p_step = NULL, const void* p_step_fast = NULL, const char* format = NULL, ImGuiInputTextFlags flags = 0); /* parasoft-suppress  CODSTA-MCPP-04 "External Library" */
    ...
    IMGUI_API bool          ColorPicker4(const char* label, float col[4], ImGuiColorEditFlags flags = 0, const float* ref_col = NULL); /* parasoft-suppress  CODSTA-MCPP-04 "External Library" */
    ...
    IMGUI_API void          LogToFile(int auto_open_depth = -1, const char* filename = NULL);   // start logging to file /* parasoft-suppress  CODSTA-MCPP-04 "External Library" */
    ...
    IMGUI_API bool          IsMousePosValid(const ImVec2* mouse_pos = NULL);                    // by convention we use (-FLT_MAX,-FLT_MAX) to denote that there is no mouse available /* parasoft-suppress  CODSTA-MCPP-04 "External Library" */
    ...
    IMGUI_API void          SetAllocatorFunctions(ImGuiMemAllocFunc alloc_func, ImGuiMemFreeFunc free_func, void* user_data = NULL); /* parasoft-suppress  CODSTA-MCPP-04 "External Library" */
...
enum ImGuiWindowFlags_ /* parasoft-suppress  CODSTA-MCPP-03 "External Library" */
{
...
// A sorting direction
enum ImGuiSortDirection : ImU8 /* parasoft-suppress  CODSTA-MCPP-03 "External Library" */
{
...
enum ImGuiKey : int /* parasoft-suppress  CODSTA-MCPP-03 "External Library" */
{
    // Keyboard
    ImGuiKey_None = 0,
...
enum ImGuiMouseButton_ /* parasoft-suppress  CODSTA-MCPP-03 "External Library" */
{
...
enum ImGuiTableColumnFlags_ /* parasoft-suppress  CODSTA-MCPP-03 "External Library" */
{
...
enum ImGuiTableBgTarget_ /* parasoft-suppress  CODSTA-MCPP-03 "External Library" */
{
...
struct ImGuiTableSortSpecs /* parasoft-suppress  MRM-49 "External Library" */
{
...
struct ImNewWrapper {};
inline void* operator new(size_t, ImNewWrapper, void* ptr) { return ptr; } /* parasoft-suppress  OPT-14 "External Library" */
inline void  operator delete(void*, ImNewWrapper, void*)   {} // This is only required so we can use the symmetrical new()
#define IM_ALLOC(_SIZE)                     ImGui::MemAlloc(_SIZE)
#define IM_FREE(_PTR)                       ImGui::MemFree(_PTR)
#define IM_PLACEMENT_NEW(_PTR)              new(ImNewWrapper(), _PTR)
#define IM_NEW(_TYPE)                       new(ImNewWrapper(), ImGui::MemAlloc(sizeof(_TYPE))) _TYPE
template<typename T> void IM_DELETE(T* p)   { if (p) { p->~T(); ImGui::MemFree(p); } } /* parasoft-suppress  MRM-31_b "External Library" */
...
struct ImVector
{
    ...
    inline ImVector()                                       { Size = Capacity = 0; Data = NULL; } /* parasoft-suppress  INIT-14 "External Library" */
    ...
    inline void         clear_destruct()                    { for (int n = 0; n < Size; n++) Data[n].~T(); clear(); }           // Important: never called automatically! always explicit. /* parasoft-suppress  OPT-18 "External Library" */
    ...
    inline T&           operator[](int i)                   { IM_ASSERT(i >= 0 && i < Size); return Data[i]; } /* parasoft-suppress  CODSTA-CPP-38 "External Library" */
...
struct ImGuiIO /* parasoft-suppress  OPT-13-DOWNGRADED "External Library" */
{
    //------------------------------------------------------------------
    ...
    bool        MouseReleased[5];                   // Mouse button went from Down to !Down /* parasoft-suppress  STL-37-DOWNGRADED "External Library" */
    bool        MouseDownOwned[5];                  // Track if button was clicked inside a dear imgui window or over void blocked by a popup. We don't request mouse capture from the application if click started outside ImGui bounds.
    bool        MouseDownOwnedUnlessPopupClose[5];  // Track if button was clicked inside a dear imgui window. /* parasoft-suppress  STL-37-DOWNGRADED "External Library" */
    bool        MouseWheelRequestAxisSwap;          // On a non-Mac system, holding SHIFT requests WheelY to perform the equivalent of a WheelX event. On a Mac system this is already enforced by the system.
    bool        MouseCtrlLeftAsRightClick;          // (OSX) Set to true when the current click was a ctrl-click that spawned a simulated right click
    float       MouseDownDuration[5];               // Duration the mouse button has been down (0.0f == just clicked)
    float       MouseDownDurationPrev[5];           // Previous time the mouse button has been down
    float       MouseDragMaxDistanceSqr[5];         // Squared maximum distance of how much mouse has traveled from the clicking point (used for moving thresholds) /* parasoft-suppress  STL-37-DOWNGRADED "External Library" */
...
struct ImGuiInputTextCallbackData /* parasoft-suppress  MRM-49 "External Library" */
{
...
struct ImGuiSizeCallbackData /* parasoft-suppress  MRM-49 "External Library" */
{
...
struct ImGuiPayload
{
    ...
    char            DataType[32 + 1];   // Data type tag (short user-supplied string, 32 characters max) /* parasoft-suppress  STL-37-DOWNGRADED "External Library" */
...
struct ImGuiTextFilter
{
    ...
    // [Internal]
    struct ImGuiTextRange /* parasoft-suppress  MRM-49 "External Library" */
    {
        const char*     b;
        const char*     e;
...
{
    ImVector<char>      Buf;
    IMGUI_API static char EmptyString[1]; /* parasoft-suppress  STL-37-DOWNGRADED "External Library" */

    ImGuiTextBuffer()   { }
    inline char         operator[](int i) const { IM_ASSERT(Buf.Data != NULL); return Buf.Data[i]; }
    const char*         begin() const           { return Buf.Data ? &Buf.front() : EmptyString; }
    const char*         end() const             { return Buf.Data ? &Buf.back() : EmptyString; }   // Buf is zero-terminated, so end() will point on the zero-terminator /* parasoft-suppress  CODSTA-CPP-65 "External Library" */
    int                 size() const            { return Buf.Size ? Buf.Size - 1 : 0; }
    bool                empty() const           { return Buf.Size <= 1; }
    void                clear()                 { Buf.clear(); }
    void                reserve(int capacity)   { Buf.reserve(capacity); }
    const char*         c_str() const           { return Buf.Data ? Buf.Data : EmptyString; }
    IMGUI_API void      append(const char* str, const char* str_end = NULL); /* parasoft-suppress  CODSTA-MCPP-04 "External Library" */
...
struct ImGuiListClipper /* parasoft-suppress  MRM-49 "External Library" */
{
    ImGuiContext*   Ctx;                // Parent UI context
...
static inline ImVec2  operator-(const ImVec2& lhs, const ImVec2& rhs)   { return ImVec2(lhs.x - rhs.x, lhs.y - rhs.y); } /* parasoft-suppress  OPT-19 "External Library" */
static inline ImVec2  operator*(const ImVec2& lhs, const ImVec2& rhs)   { return ImVec2(lhs.x * rhs.x, lhs.y * rhs.y); }
static inline ImVec2  operator/(const ImVec2& lhs, const ImVec2& rhs)   { return ImVec2(lhs.x / rhs.x, lhs.y / rhs.y); }
...
static inline ImVec2& operator*=(ImVec2& lhs, const ImVec2& rhs)        { lhs.x *= rhs.x; lhs.y *= rhs.y; return lhs; }
static inline ImVec2& operator/=(ImVec2& lhs, const ImVec2& rhs)        { lhs.x /= rhs.x; lhs.y /= rhs.y; return lhs; }
static inline bool    operator==(const ImVec2& lhs, const ImVec2& rhs)  { return lhs.x == rhs.x && lhs.y == rhs.y; } /* parasoft-suppress  CODSTA-225 "External Library" */ /* parasoft-suppress  MISRA2004-13_3 "External Library" */
static inline bool    operator!=(const ImVec2& lhs, const ImVec2& rhs)  { return lhs.x != rhs.x || lhs.y != rhs.y; }
static inline ImVec4  operator+(const ImVec4& lhs, const ImVec4& rhs)   { return ImVec4(lhs.x + rhs.x, lhs.y + rhs.y, lhs.z + rhs.z, lhs.w + rhs.w); } /* parasoft-suppress  OPT-33 "External Library" */
static inline ImVec4  operator-(const ImVec4& lhs, const ImVec4& rhs)   { return ImVec4(lhs.x - rhs.x, lhs.y - rhs.y, lhs.z - rhs.z, lhs.w - rhs.w); } /* parasoft-suppress  OPT-33 "External Library" */
static inline ImVec4  operator*(const ImVec4& lhs, const ImVec4& rhs)   { return ImVec4(lhs.x * rhs.x, lhs.y * rhs.y, lhs.z * rhs.z, lhs.w * rhs.w); }
static inline bool    operator==(const ImVec4& lhs, const ImVec4& rhs)  { return lhs.x == rhs.x && lhs.y == rhs.y && lhs.z == rhs.z && lhs.w == rhs.w; } /* parasoft-suppress  CODSTA-225 "External Library" */
static inline bool    operator!=(const ImVec4& lhs, const ImVec4& rhs)  { return lhs.x != rhs.x || lhs.y != rhs.y || lhs.z != rhs.z || lhs.w != rhs.w; } /* parasoft-suppress  MISRA2004-13_3 "External Library" */
IM_MSVC_RUNTIME_CHECKS_RESTORE
#endif
...
#define IM_COL32_A_MASK     0xFF000000 /* parasoft-suppress  CODSTA-03 "External Library" */
#else
...
#endif
#endif
#define IM_COL32(R,G,B,A)    (((ImU32)(A)<<IM_COL32_A_SHIFT) | ((ImU32)(B)<<IM_COL32_B_SHIFT) | ((ImU32)(G)<<IM_COL32_G_SHIFT) | ((ImU32)(R)<<IM_COL32_R_SHIFT)) /* parasoft-suppress  MISRA2004-19_7 "External Library" */
...
struct ImColor
{
    ...
    inline operator ImU32() const                                   { return ImGui::ColorConvertFloat4ToU32(Value); } /* parasoft-suppress  CODSTA-MCPP-01 "External Library" */
...
struct ImGuiSelectionBasicStorage /* parasoft-suppress  OPT-13-DOWNGRADED "External Library" */
{
    // Members
...
struct ImGuiSelectionExternalStorage /* parasoft-suppress  MRM-49 "External Library" */
{
    // Members
...
struct ImDrawCmd
{
    ...
    ImDrawCmd()     { memset(this, 0, sizeof(*this)); } // Also ensure our padding fields are zeroed /* parasoft-suppress  INIT-06 "External Library" */
...
struct ImDrawListSplitter /* parasoft-suppress  MRM-40_d "External Library" */
{
...
struct ImDrawList
{
    ...
    IMGUI_API ImDrawList(ImDrawListSharedData* shared_data); /* parasoft-suppress  CODSTA-CPP-04 "External Library" */
    ...
    IMGUI_API void  AddText(ImFont* font, float font_size, const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end = NULL, float wrap_width = 0.0f, const ImVec4* cpu_fine_clip_rect = NULL); /* parasoft-suppress  CODSTA-MCPP-04 "External Library" */
...
struct ImDrawData /* parasoft-suppress  OPT-13-DOWNGRADED "External Library" */
{
...
struct ImFontAtlasCustomRect /* parasoft-suppress  MRM-49 "External Library" */ /* parasoft-suppress  OPT-13-DOWNGRADED "External Library" */
{
...
struct ImFontAtlas /* parasoft-suppress  OPT-13-DOWNGRADED "External Library" */
{
    ...
    IMGUI_API void              GetTexDataAsAlpha8(unsigned char** out_pixels, int* out_width, int* out_height, int* out_bytes_per_pixel = NULL);  // 1 byte per-pixel /* parasoft-suppress  CODSTA-MCPP-04 "External Library" */
...
struct ImFont
{
    ...
    bool                        IsLoaded() const                    { return ContainerAtlas != NULL; } /* parasoft-suppress  CODSTA-MCPP-04 "External Library" */
...
struct ImGuiViewport /* parasoft-suppress  MRM-49 "External Library" */
{
