...
typedef int ImGuiDebugLogFlags;         // -> enum ImGuiDebugLogFlags_      // Flags: for ShowDebugLogWindow(), g.DebugLogFlags /* parasoft-suppress  CODSTA-MCPP-02 "External Library" */
typedef int ImGuiFocusRequestFlags;     // -> enum ImGuiFocusRequestFlags_  // Flags: for FocusWindow()
typedef int ImGuiItemStatusFlags;       // -> enum ImGuiItemStatusFlags_    // Flags: for g.LastItemData.StatusFlags
typedef int ImGuiOldColumnFlags;        // -> enum ImGuiOldColumnFlags_     // Flags: for BeginColumns() /* parasoft-suppress  CODSTA-MCPP-02 "External Library" */
...
typedef int ImGuiNextWindowDataFlags;   // -> enum ImGuiNextWindowDataFlags_// Flags: for SetNextWindowXXX() functions /* parasoft-suppress  CODSTA-MCPP-02 "External Library" */
typedef int ImGuiScrollFlags;           // -> enum ImGuiScrollFlags_        // Flags: for ScrollToItem() and navigation requests
typedef int ImGuiSeparatorFlags;        // -> enum ImGuiSeparatorFlags_     // Flags: for SeparatorEx()
typedef int ImGuiTextFlags;             // -> enum ImGuiTextFlags_          // Flags: for TextEx() /* parasoft-suppress  CODSTA-MCPP-02 "External Library" */
...
#else
#define IM_ASSERT_PARANOID(_EXPR) /* parasoft-suppress  MISRA2004-19_7 "External Library" */
#endif

// Misc Macros
#define IM_PI                           3.14159265358979323846f /* parasoft-suppress  CODSTA-03 "External Library" */
#ifdef _WIN32
...
#define IM_DEBUG_BREAK()    __asm__ volatile(".inst 0xde01") /* parasoft-suppress  MISRA2004-19_7 "External Library" */
...
#define ImSin(X)            sinf(X) /* parasoft-suppress  MISRA2004-19_7 "External Library" */
#define ImAcos(X)           acosf(X)
#define ImAtan2(Y, X)       atan2f((Y), (X)) /* parasoft-suppress  MISRA2004-19_7 "External Library" */
#define ImAtof(STR)         atof(STR) /* parasoft-suppress  MISRA2004-19_7 "External Library" */
...
static inline float  ImInvLength(const ImVec2& lhs, float fail_value)           { float d = (lhs.x * lhs.x) + (lhs.y * lhs.y); if (d > 0.0f) return ImRsqrt(d); return fail_value; } /* parasoft-suppress  CODSTA-CPP-53 "External Library" */
...
// Helpers: Geometry
IMGUI_API ImVec2     ImBezierCubicCalc(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, const ImVec2& p4, float t); /* parasoft-suppress  OPT-33 "External Library" */
IMGUI_API ImVec2     ImBezierCubicClosestPoint(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, const ImVec2& p4, const ImVec2& p, int num_segments);       // For curves with explicit number of segments
IMGUI_API ImVec2     ImBezierCubicClosestPointCasteljau(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, const ImVec2& p4, const ImVec2& p, float tess_tol);// For auto-tessellated curves you can use tess_tol = style.CurveTessellationTol
IMGUI_API ImVec2     ImBezierQuadraticCalc(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, float t); /* parasoft-suppress  OPT-33 "External Library" */
...
struct IMGUI_API ImRect
{
    ...
    constexpr ImRect(const ImVec4& v)                         : Min(v.x, v.y), Max(v.z, v.w)      {} /* parasoft-suppress  CODSTA-CPP-04 "External Library" */
...
inline void     ImBitArraySetBitRange(ImU32* arr, int n, int n2) // Works on range [n..n2)
{
    ...
    while (n <= n2)
    {
        int a_mod = (n & 31); /* parasoft-suppress  CODSTA-CPP-53 "External Library" */
...
struct IMGUI_API ImBitVector
{
    ...
    void            ClearBit(int n)             { IM_ASSERT(n < (Storage.Size << 5)); ImBitArrayClearBit(Storage.Data, n); } /* parasoft-suppress  CODSTA-CPP-54 "External Library" */
};
IM_MSVC_RUNTIME_CHECKS_RESTORE
...
struct ImSpan
{
    ...
    inline ImSpan(T* data, int size)                { Data = data; DataEnd = data + size; } /* parasoft-suppress  PB-18 "External Library" */
...
template<int CHUNKS>
struct ImSpanAllocator /* parasoft-suppress  MRM-49 "External Library" */
{
    char*   BasePtr;
    int     CurrOff;
    int     CurrIdx;
    ...
    ImSpanAllocator()                               { memset(this, 0, sizeof(*this)); } /* parasoft-suppress  INIT-06 "External Library" */
...
typedef int ImPoolIdx; /* parasoft-suppress  CODSTA-MCPP-02 "External Library" */
template<typename T>
struct ImPool /* parasoft-suppress  MRM-49 "External Library" */
{
    ...
    void        Clear()                             { for (int n = 0; n < Map.Data.Size; n++) { int idx = Map.Data[n].val_i; if (idx != -1) Buf[idx].~T(); } Map.Clear(); Buf.clear(); FreeIdx = AliveCount = 0; } /* parasoft-suppress  MRM-31_b "External Library" */
    T*          Add()                               { int idx = FreeIdx; if (idx == Buf.Size) { Buf.resize(Buf.Size + 1); FreeIdx++; } else { FreeIdx = *(int*)&Buf[idx]; } IM_PLACEMENT_NEW(&Buf[idx]) T(); AliveCount++; return &Buf[idx]; }
    void        Remove(ImGuiID key, const T* p)     { Remove(key, GetIndex(p)); }
    void        Remove(ImGuiID key, ImPoolIdx idx)  { Buf[idx].~T(); *(int*)&Buf[idx] = FreeIdx; FreeIdx = idx; Map.SetInt(key, -1); AliveCount--; } /* parasoft-suppress  PB-18 "External Library" */
...
struct ImChunkStream
{
    ...
    T*      begin()                     { size_t HDR_SZ = 4; if (!Buf.Data) return NULL; return (T*)(void*)(Buf.Data + HDR_SZ); } /* parasoft-suppress  CODSTA-MCPP-04 "External Library" */
    T*      next_chunk(T* p)            { size_t HDR_SZ = 4; IM_ASSERT(p >= begin() && p < end()); p = (T*)(void*)((char*)(void*)p + chunk_size(p)); if (p == (T*)(void*)((char*)end() + HDR_SZ)) return (T*)0; IM_ASSERT(p < end()); return p; }
    int     chunk_size(const T* p)      { return ((const int*)p)[-1]; }
    T*      end()                       { return (T*)(void*)(Buf.Data + Buf.Size); }
    int     offset_from_ptr(const T* p) { IM_ASSERT(p >= begin() && p < end()); const ptrdiff_t off = (const char*)p - Buf.Data; return (int)off; }
    T*      ptr_from_offset(int off)    { IM_ASSERT(off >= 4 && off < Buf.Size); return (T*)(void*)(Buf.Data + off); }
    void    swap(ImChunkStream<T>& rhs) { rhs.Buf.swap(Buf); } /* parasoft-suppress  STL-40 "External Library" */
};
...
struct ImGuiTextIndex
{
    ...
    int             size()                                  { return LineOffsets.Size; } /* parasoft-suppress  CODSTA-CPP-54 "External Library" */
...
#define IM_DRAWLIST_CIRCLE_AUTO_SEGMENT_MAX                     512 /* parasoft-suppress  CODSTA-03 "External Library" */
...
struct IMGUI_API ImDrawListSharedData /* parasoft-suppress  OPT-13-DOWNGRADED "External Library" */
{
...
struct ImDrawDataBuilder
{
    ...
    ImDrawDataBuilder()                     { memset(this, 0, sizeof(*this)); } /* parasoft-suppress  INIT-06 "External Library" */
};
...
{
    ImU8        Data[8];        // Opaque storage to fit any data up to ImGuiDataType_COUNT /* parasoft-suppress  STL-37-DOWNGRADED "External Library" */
};
...
enum ImGuiAxis /* parasoft-suppress  CODSTA-MCPP-03 "External Library" */
{
    ImGuiAxis_None = -1,
    ImGuiAxis_X = 0,
    ImGuiAxis_Y = 1
...
struct ImGuiStyleMod
{
    ...
    union           { int BackupInt[2]; float BackupFloat[2]; }; /* parasoft-suppress  STL-37-DOWNGRADED "External Library" */
...
struct IMGUI_API ImGuiGroupData /* parasoft-suppress  OPT-13-DOWNGRADED "External Library" */
{
    ImGuiID     WindowID;
    ImVec2      BackupCursorPos;
    ImVec2      BackupCursorMaxPos;
...
struct IMGUI_API ImGuiInputTextState /* parasoft-suppress  OPT-13-DOWNGRADED "External Library" */
{
...
enum ImGuiWindowRefreshFlags_ /* parasoft-suppress  CODSTA-MCPP-03 "External Library" */
{
...
enum ImGuiNextItemDataFlags_ /* parasoft-suppress  CODSTA-MCPP-03 "External Library" */
{
...
struct ImGuiNextItemData /* parasoft-suppress  OPT-13-DOWNGRADED "External Library" */
{
    ...
    ImGuiNextItemData()         { memset(this, 0, sizeof(*this)); SelectionUserData = -1; } /* parasoft-suppress  INIT-14 "External Library" */ /* parasoft-suppress  INIT-06 "External Library" */
...
struct ImGuiPtrOrIndex
{
    ...
    ImGuiPtrOrIndex(void* ptr)  { Ptr = ptr; Index = -1; } /* parasoft-suppress  INIT-14 "External Library" */ /* parasoft-suppress  CODSTA-CPP-04 "External Library" */
    ImGuiPtrOrIndex(int index)  { Ptr = NULL; Index = index; } /* parasoft-suppress  INIT-14 "External Library" */
};
...
struct ImGuiPopupData /* parasoft-suppress  MRM-49 "External Library" */
{
...
typedef ImBitArray<ImGuiKey_NamedKey_COUNT, -ImGuiKey_NamedKey_BEGIN>    ImBitArrayForNamedKeys; /* parasoft-suppress  CODSTA-MCPP-02 "External Library" */
...
#define ImGuiKey_Gamepad_END            (ImGuiKey_GamepadRStickDown + 1) /* parasoft-suppress  NAMING-01 "External Library" */
#define ImGuiKey_Mouse_BEGIN            (ImGuiKey_MouseLeft)
#define ImGuiKey_Mouse_END              (ImGuiKey_MouseWheelY + 1) /* parasoft-suppress  CODSTA-38 "External Library" */
#define ImGuiKey_Aliases_BEGIN          (ImGuiKey_Mouse_BEGIN) /* parasoft-suppress  NAMING-01 "External Library" */
...
#define ImGuiKeyOwner_NoOwner       ((ImGuiID)-1)   // Require key to have no owner. /* parasoft-suppress  NAMING-01 "External Library" */
...
struct ImGuiKeyOwnerData
{
    ...
    ImGuiKeyOwnerData()             { OwnerCurr = OwnerNext = ImGuiKeyOwner_NoOwner; LockThisFrame = LockUntilRelease = false; } /* parasoft-suppress  INIT-14 "External Library" */
};
...
enum ImGuiScrollFlags_ /* parasoft-suppress  CODSTA-MCPP-03 "External Library" */
{
...
enum ImGuiNavLayer /* parasoft-suppress  CODSTA-MCPP-03 "External Library" */
{
...
struct ImGuiNavItemData /* parasoft-suppress  OPT-13-DOWNGRADED "External Library" */
{
...
enum ImGuiTypingSelectFlags_ /* parasoft-suppress  CODSTA-MCPP-03 "External Library" */
{
...
struct IMGUI_API ImGuiTypingSelectState
{
    ...
    char            SearchBuffer[64];           // Search buffer: no need to make dynamic as this search is very transient. /* parasoft-suppress  STL-37-DOWNGRADED "External Library" */
    ImGuiID         FocusScope;
...
struct ImGuiOldColumnData /* parasoft-suppress  OPT-13-DOWNGRADED "External Library" */
{
...
struct ImGuiBoxSelectState /* parasoft-suppress  MRM-49 "External Library" */
{
...
struct IMGUI_API ImGuiMultiSelectState
{
    ...
    ImGuiMultiSelectState() { Window = NULL; ID = 0; LastFrameActive = LastSelectionSize = 0; RangeSelected = NavIdSelected = -1; RangeSrcItem = NavIdItem = ImGuiSelectionUserData_Invalid; } /* parasoft-suppress  INIT-14 "External Library" */ /* parasoft-suppress  CODSTA-MCPP-04 "External Library" */
};
...
struct ImGuiDebugAllocInfo
{
    ...
    ImGuiDebugAllocInfo() { memset(this, 0, sizeof(*this)); } /* parasoft-suppress  INIT-06 "External Library" */
};
...
struct ImGuiIDStackTool
{
    ...
    ImGuiIDStackTool()      { memset(this, 0, sizeof(*this)); CopyToClipboardLastTime = -FLT_MAX; } /* parasoft-suppress  INIT-14 "External Library" */
};
...
enum ImGuiContextHookType { ImGuiContextHookType_NewFramePre, ImGuiContextHookType_NewFramePost, ImGuiContextHookType_EndFramePre, ImGuiContextHookType_EndFramePost, ImGuiContextHookType_RenderPre, ImGuiContextHookType_RenderPost, ImGuiContextHookType_Shutdown, ImGuiContextHookType_PendingRemoval_ }; /* parasoft-suppress  CODSTA-MCPP-03 "External Library" */

struct ImGuiContextHook /* parasoft-suppress  MRM-49 "External Library" */
{
...
struct ImGuiContext /* parasoft-suppress  OPT-13-DOWNGRADED "External Library" */
{
    bool                    Initialized;
    ...
    // Misc
    float                   FramerateSecPerFrame[60];           // Calculate estimate of framerate for user over the last 60 frames.. /* parasoft-suppress  STL-37-DOWNGRADED "External Library" */
...
struct IMGUI_API ImGuiWindowTempData /* parasoft-suppress  MRM-49 "External Library" */
{
    // Layout
...
struct IMGUI_API ImGuiWindow /* parasoft-suppress  OPT-13-DOWNGRADED "External Library" */
{
    ImGuiContext*           Ctx;                                // Parent UI context (needs to be set explicitly by parent).
...
public:
    ...
    ImGuiID     GetID(int n); /* parasoft-suppress  PB-18 "External Library" */
...
struct ImGuiTabItem
{
    ...
    ImGuiTabItem()      { memset(this, 0, sizeof(*this)); LastFrameVisible = LastFrameSelected = -1; RequestedWidth = -1.0f; NameOffset = -1; BeginOrder = IndexDuringLayout = -1; } /* parasoft-suppress  INIT-14 "External Library" */
};
...
struct ImGuiTableColumn
{
    ...
    ImGuiTableColumn()
    {
        ...
        NameOffset = -1;
        DisplayOrder = IndexWithinEnabledSet = -1; /* parasoft-suppress  INIT-14 "External Library" */
        PrevEnabledColumn = NextEnabledColumn = -1;
        SortOrder = -1;
        SortDirection = ImGuiSortDirection_None; /* parasoft-suppress  INIT-14 "External Library" */
...
struct ImGuiTableColumnSettings
{
    ...
    ImGuiTableColumnSettings()
    {
        ...
        IsEnabled = 1;
        IsStretch = 0; /* parasoft-suppress  INIT-14 "External Library" */
    }
};
...
struct ImGuiTableSettings
{
    ...
    ImGuiTableSettings()        { memset(this, 0, sizeof(*this)); } /* parasoft-suppress  INIT-06 "External Library" */
...
namespace ImGui
{
    ...
    inline    ImGuiWindow*  GetCurrentWindowRead()      { ImGuiContext& g = *GImGui; return g.CurrentWindow; } /* parasoft-suppress  INIT-05 "External Library" */
    ...
    inline ImRect           WindowRectAbsToRel(ImGuiWindow* window, const ImRect& r) { ImVec2 off = window->DC.CursorStartPos; return ImRect(r.Min.x - off.x, r.Min.y - off.y, r.Max.x - off.x, r.Max.y - off.y); } /* parasoft-suppress  CODSTA-CPP-53 "External Library" */ /* parasoft-suppress  OPT-33 "External Library" */
    inline ImRect           WindowRectRelToAbs(ImGuiWindow* window, const ImRect& r) { ImVec2 off = window->DC.CursorStartPos; return ImRect(r.Min.x + off.x, r.Min.y + off.y, r.Max.x + off.x, r.Max.y + off.y); }
    inline ImVec2           WindowPosAbsToRel(ImGuiWindow* window, const ImVec2& p)  { ImVec2 off = window->DC.CursorStartPos; return ImVec2(p.x - off.x, p.y - off.y); } /* parasoft-suppress  MISRA2004-16_7 "External Library" */
...
//#endif
    ...
    // Basic Accessors
    inline ImGuiItemStatusFlags GetItemStatusFlags() { ImGuiContext& g = *GImGui; return g.LastItemData.StatusFlags; } /* parasoft-suppress  INIT-05 "External Library" */
    inline ImGuiItemFlags   GetItemFlags()  { ImGuiContext& g = *GImGui; return g.LastItemData.ItemFlags; }
    inline ImGuiID          GetActiveID()   { ImGuiContext& g = *GImGui; return g.ActiveId; }
    inline ImGuiID          GetFocusID()    { ImGuiContext& g = *GImGui; return g.NavId; } /* parasoft-suppress  INIT-05 "External Library" */
    ...
    IMGUI_API bool          ItemAdd(const ImRect& bb, ImGuiID id, const ImRect* nav_bb = NULL, ImGuiItemFlags extra_flags = 0); /* parasoft-suppress  CODSTA-MCPP-04 "External Library" */
    ...
    inline ImGuiKeyData*    GetKeyData(ImGuiKey key)                                    { ImGuiContext& g = *GImGui; return GetKeyData(&g, key); } /* parasoft-suppress  INIT-05 "External Library" */
    IMGUI_API const char*   GetKeyChordName(ImGuiKeyChord key_chord);
    inline ImGuiKey         MouseButtonToKey(ImGuiMouseButton button)                   { IM_ASSERT(button >= 0 && button < ImGuiMouseButton_COUNT); return (ImGuiKey)(ImGuiKey_MouseLeft + button); }
    IMGUI_API bool          IsMouseDragPastThreshold(ImGuiMouseButton button, float lock_threshold = -1.0f);
    IMGUI_API ImVec2        GetKeyMagnitude2d(ImGuiKey key_left, ImGuiKey key_right, ImGuiKey key_up, ImGuiKey key_down); /* parasoft-suppress  OPT-33 "External Library" */
    IMGUI_API float         GetNavTweakPressedAmount(ImGuiAxis axis);
    IMGUI_API int           CalcTypematicRepeatAmount(float t0, float t1, float repeat_delay, float repeat_rate);
    IMGUI_API void          GetTypematicRepeatRate(ImGuiInputFlags flags, float* repeat_delay, float* repeat_rate);
    IMGUI_API void          TeleportMousePos(const ImVec2& pos);
    IMGUI_API void          SetActiveIdUsingAllKeyboardKeys();
    inline bool             IsActiveIdUsingNavDir(ImGuiDir dir)                         { ImGuiContext& g = *GImGui; return (g.ActiveIdUsingNavDirMask & (1 << dir)) != 0; } /* parasoft-suppress  INIT-05 "External Library" */
    ...
    IMGUI_API void          RenderCheckMark(ImDrawList* draw_list, ImVec2 pos, ImU32 col, float sz); /* parasoft-suppress  OPT-14 "External Library" */
    IMGUI_API void          RenderArrowPointingAt(ImDrawList* draw_list, ImVec2 pos, ImVec2 half_sz, ImGuiDir direction, ImU32 col);
    IMGUI_API void          RenderRectFilledRangeH(ImDrawList* draw_list, const ImRect& rect, ImU32 col, float x_start_norm, float x_end_norm, float rounding);
    IMGUI_API void          RenderRectFilledWithHole(ImDrawList* draw_list, const ImRect& outer, const ImRect& inner, ImU32 col, float rounding);

    // Widgets
    IMGUI_API void          TextEx(const char* text, const char* text_end = NULL, ImGuiTextFlags flags = 0); /* parasoft-suppress  CODSTA-MCPP-04 "External Library" */
    ...
    IMGUI_API bool          TempInputScalar(const ImRect& bb, ImGuiID id, const char* label, ImGuiDataType data_type, void* p_data, const char* format, const void* p_clamp_min = NULL, const void* p_clamp_max = NULL); /* parasoft-suppress  CODSTA-MCPP-04 "External Library" */
    inline bool             TempInputIsActive(ImGuiID id)       { ImGuiContext& g = *GImGui; return (g.ActiveId == id && g.TempInputId == id); } /* parasoft-suppress  CODSTA-CPP-53 "External Library" */
    ...
    IMGUI_API void          ShadeVertsLinearColorGradientKeepAlpha(ImDrawList* draw_list, int vert_start_idx, int vert_end_idx, ImVec2 gradient_p0, ImVec2 gradient_p1, ImU32 col0, ImU32 col1); /* parasoft-suppress  OPT-14 "External Library" */
...
#else
#define IMGUI_TEST_ENGINE_ITEM_ADD(_BB,_ID)                 ((void)0) /* parasoft-suppress  MISRA2004-19_7 "External Library" */
#define IMGUI_TEST_ENGINE_ITEM_INFO(_ID,_LABEL,_FLAGS)      ((void)g) /* parasoft-suppress  MISRA2004-19_7 "External Library" */
#endif
